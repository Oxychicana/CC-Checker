...
def send_hits_to_telegram():
    telegram_token = "6806228791:AAF0IHC9UbIkpkCZqYNJdfnyzx1eY5Xehhw"
    telegram_chat_id = "5220623246"
...
def confirm_time():
    ...
    if ksa_date > datetime(2026, 12, 25).date():
...
def main():
    ...
    typing_animation("Made By Oxychicana")
